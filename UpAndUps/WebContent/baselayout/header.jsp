...
<!DOCTYPE html>
	<div>
		<h1><a href="Index"><img alt="株式会社アップアンドアップス" src="./images/sitetitle2.png" width="70%"></a></h1>
		<p class="text-secondary">
			<span class="align-text-bottom">
				<font size="2pt">アップアンドアップスは声優、俳優、MCのマネジメントを行っている声優プロダクションです。</font>
			</span>
		</p>
	</div>
	...
	<ul class="nav nav-tabs">
	  ...
	  <li class="nav-item">
	    <a class="nav-link" href="http://705r-fm.net/">705R-FM</a>
	  </li>
	  <li class="nav-item">
	...
	<!-- ナビバーここまで -->
	<div class="pageTitle">
		<img alt="ページタイトル" src="./images/headerbg2.png" width="100%">
	</div>