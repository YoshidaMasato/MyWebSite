			...
			<div class="col-lg-8 offset-lg-2">
				<form action="user_list.html" method="post">
					...
					<div class="form-group row">
					  ...
					  <div class="col-sm-8">
					    <input type="text" class="form-control" id="inputLoginId" value="">
					  </div>
					</div>
					...
					<!-- パスワード(確認) -->
					<div class="form-group row">
					  <label for="inputPasswordCheck" class="col-sm-4 col-form-label">パスワード(確認)</label>
					  <div class="col-sm-8">
					    <input type="password" class="form-control" id="inputPasswordCheck" placeholder="">
					  </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8 text-left">
							<div class="form-check form-check-inline">
							  <input class="form-check-input" type="radio" name="bloodtype" id="inlineRadio1" value="option1">
					...
					<div class="form-group row">
					  ...
					  <div class="col-sm-8">
					    <input type="text" class="form-control" id="inputSkill" value="">
					  </div>
					</div>
					...
					<!-- 登録用パスワード -->
					<div class="form-group row">
					  <label for="mPassword" class="col-sm-4 col-form-label">登録用パスワード</label>
					  <div class="col-sm-8">
					    <input type="password" class="form-control" id="mPassword" placeholder="">
					  </div>
					</div>
